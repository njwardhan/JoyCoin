...
contract('JoyToken', function(accounts){
    ...
    it('handles the transfer token ownership', function(){
        return JoyToken.deployed().then(function(instance){
            tokenInstance = instance;
            // 'require' statement tested by transferring something larger than the sender's balance
    ...
    it('handles delegated token transfers', function(){
        return JoyToken.deployed().then(function(instance){
            ...
            // Try transferring something langer than the sender's balance
            ...
            assert(error.message.indexOf('revert') >=0, 'cannot transfer value more than the approved amount');
